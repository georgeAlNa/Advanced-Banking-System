...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<AccountComponent> roots)?  success,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
return success(_that.roots);case Error() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<AccountComponent> roots)  success,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case Loading():
return loading();case Success():
return success(_that.roots);case Error():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<AccountComponent> roots)?  success,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case Success() when success != null:
...
class Loading implements AccountsState {
  const Loading();
...
class Success implements AccountsState {
  const Success({required final  List<AccountComponent> roots}): _roots = roots;
  

 final  List<AccountComponent> _roots;
 List<AccountComponent> get roots {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Success&&const DeepCollectionEquality().equals(other._roots, _roots));
}
...
@override
String toString() {
  return 'AccountsState.success(roots: $roots)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<$Res> implements $AccountsStateCopyWith<$Res> {
  factory $SuccessCopyWith(Success value, $Res Function(Success) _then) = _$SuccessCopyWithImpl;
@useResult
$Res call({
 List<AccountComponent> roots
});
...
class Error implements AccountsState {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $AccountsStateCopyWith<$Res> {
